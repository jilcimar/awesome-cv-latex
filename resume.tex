...
\name{Jilcimar da S.}{Fernandes}
\position{Técnico em Informatica}
\address{Av. Cap.Mor Gouveia - Lagoa Nova, Natal - RN, 59076-400}

\mobile{(+55) 84 99629-2599}
\email{jilcimar@ufrn.edu.br}
\homepage{jilcimar.github.io}
\github{jilcimar}
\linkedin{jilcimar}
% \gitlab{gitlab-id}
...
\makecvfooter
	{}
  {Jilcimar da S. Fernandes~~~·~~~Resumo}
  {\thepage}
